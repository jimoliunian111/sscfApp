    ...
    <div class="occupation-inquire-choice">
      ...
      <p class="occupation-inquire-choice-notice" 
          v-if="vocationSearchNumber === 4
                && vocationSelected[vocationSelected.length - 1].level <= maxLeval">
      ...
      <popup class="search-container" 
        ...
        <div class="search-content">
          ...
          <div class="search-item" 
            ...
            <p>{{ item.name }}</p>
            <span class="search-item-success" v-if="item.level <= maxLeval">
              {{ item.level }}类 （符合投保条件）
            </span>
            <span class="search-item-fail" v-else>
...
import { searchProfession } from '@/utils/apis';
