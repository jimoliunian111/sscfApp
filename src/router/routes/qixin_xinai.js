export default [
  {
      ...
      component: () => import('@/products/qixin/xinai/detail/detail')
  },
  {
      ...
      component: () => import('@/products/qixin/xinai/insure-info/insure-info')
  },
  {
    ...
    component: () => import('@/products/qixin/xinai/check-stand/check-stand')
  }
];