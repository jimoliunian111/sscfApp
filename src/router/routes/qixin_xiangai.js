export default [
  {
      ...
      component: () => import('@/products/qixin/xiangai/detail/detail')
  },
  {
      ...
      component: () => import('@/products/qixin/xiangai/insure-info/insure-info')
  },
  {
    ...
    component: () => import('@/products/qixin/xiangai/check-stand/check-stand')
  }
];